...
export const ForgotPasswordModal: React.FC<ForgotPasswordModalProps> = ({
  ...
  const [phone, setPhone] = useState<string>('012345004'); // default to cashier for quick demo
  ...
  const adminUser = users.find(u => u.role_name === 'admin') || users[0];
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          {/* Quick Demo Staff Phone Chips */}
          <div style={{ marginTop: '8px' }}>
            <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginBottom: '4px' }}>
              Quick-select demo phone:
            </div>
              ...
              {users.map(u => (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    cursor: 'pointer',
                    background: phone === u.phone ? 'rgba(34, 158, 217, 0.15)' : 'var(--bg-color)',
                    border: phone === u.phone ? '1.5px solid #229ED9' : '1px solid var(--border-color)',
                    color: phone === u.phone ? '#229ED9' : 'var(--text-dark)'
                  }}
                >
                  {u.name.split(' ')[0]} ({u.phone})
                </button>
              ))}
            </div>
          </div>
