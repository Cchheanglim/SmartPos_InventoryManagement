...
export const LogoutConfirmModal: React.FC = () => {
  ...
  const handleEmergencyOverride = () => {
    if (
      window.confirm(
        `Confirm Emergency Terminal Lock for ${currentUser.name}?\n\nThe attendance shift will remain ACTIVE in the system ledger. Use this only for temporary stepping away, emergencies, or manager intervention.`
      )
    ) {
