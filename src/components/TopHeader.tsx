        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div
            ...
            style={{
              ...
              cursor: (currentUser.role_name === 'admin' || hasPermission('manage_currency')) ? 'pointer' : 'default'
            }}
            onClick={() => {
              if (currentUser.role_name === 'admin' || hasPermission('manage_currency')) {
            ...
            title={
              (currentUser.role_name === 'admin' || hasPermission('manage_currency'))
