...
export const ProfileView: React.FC = () => {
  ...
  const isAdmin = currentUser.role_name === 'admin' || hasPermission('manage_users');
            ...
            {showAvatarMenu && (
              ...
              >
                ...
                <button
                  ...
                  onClick={() => {
                    setShowAvatarMenu(false);
                    const defaultPic = currentUser.role_name === 'admin' ? 'admin.png' : 'cashier.png';
              ...
              <div style={{ flex: 1, minWidth: '260px' }}>
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '12px' }}>
                  <button
                    ...
                    onClick={() => {
                      const safeDefault = targetUser.role_name === 'admin' ? 'admin.png' : 'cashier.png';
