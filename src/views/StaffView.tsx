...
export const StaffView: React.FC = () => {
  ...
  const handleInitiateRolePermissionToggle = (
    ...
    if (isCurrentlyGranted && roleName === 'admin' && perm.name === 'manage_roles') {
  ...
  const handleSaveStaff = (e: React.FormEvent) => {
    ...
    const roleId = staffForm.role_name === 'admin' ? 1 : staffForm.role_name === 'admin_assistant' ? 2 : staffForm.role_name === 'inventory_manager' ? 3 : 4;
      ...
      {staffTab === 'directory' && (
        <div className="card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h2 style={{ margin: 0 }}>Staff Team Members</h2>
              ...
              <tbody>
                {users.map(u => (
                  <tr key={u.id}>
                    ...
                    <td>
                      <span className={`badge ${u.is_active ? 'badge-ok' : 'badge-low'}`}>
                    ...
                    <td style={{ textAlign: 'right' }}>
                      <div style={{ display: 'inline-flex', gap: '6px' }}>
                        ...
                        {(currentUser.role_name === 'admin' || hasPermission('manage_users')) && (
                          <>
                            <button
                              className="btn-icon"
                              style={{ color: '#0284c7' }}
                    ...
                    <td style={{ textAlign: 'right' }}>
                      {r.is_open && hasPermission('manage_users') && (
                        <button
                          ...
                          onClick={() => {
                            if (confirm(`Force close active shift for ${r.user_name}?`)) {
                                  ...
                                  {isLocked ? (
                                    ...
                                    <div style={{ display: 'inline-flex', gap: '5px' }}>
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          if (confirm(`Are you sure you want to delete permission "${perm.display_name || perm.name}"?`)) {
        ...
        <div className="modal-overlay" onClick={() => setViewingStaff(null)}>
          <div className="modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: '500px' }}>
            ...
            <dl className="info-grid">
              ...
              <dt>Status:</dt>
              <dd>{viewingStaff.is_active ? 'Active' : 'Inactive'}</dd>
              <dt>Total Shifts:</dt>
            ...
            <div style={{ display: 'flex', gap: '16px', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <button
                  ...
                  onClick={() => {
                    const fallback = moderatingUser.role_name === 'admin' ? 'admin.png' : 'cashier.png';
