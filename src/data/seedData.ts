...
export const INITIAL_ROLES: RoleItem[] = [
  { id: 1, name: 'admin', display_name: 'Admin', is_system: true, description: 'Full system control and user governance' },
  { id: 2, name: 'admin_assistant', display_name: 'Admin Assistant', is_system: true, description: 'Operations assistant and reporting' },
  { id: 3, name: 'inventory_manager', display_name: 'Inventory Manager', is_system: true, description: 'Product catalog and stock adjustments' },
  { id: 4, name: 'cashier', display_name: 'Cashier', is_system: true, description: 'Point of Sale checkout and customer lookups' }
];
...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: 2,
    name: 'Sokha Assistant',
    email: 'assistant@smartpos.local',
    phone: '012345002',
    role_id: 2,
